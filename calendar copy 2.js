...
const renderCalendar = () => {
    ...
    // Dates 그리기
    document.querySelector(".past-dates").style.display = "none";
    document.querySelector(".future-dates").style.display = "none";
...
function pastRenderCalendar() {
    console.log("과거월 작동 되나요?");
    ...
    document.querySelector(".future-dates").style.display = "none";
    document.querySelector(".past-dates").innerHTML = dates.join("");
    document.querySelector(".past-dates").style.display = "flex";
...
function futureRenderCalendar() {
    ...
    document.querySelector(".dates").style.display = "none";
    document.querySelector(".past-dates").style.display = "none";
    document.querySelector(".future-dates").innerHTML = dates.join("");
    document.querySelector(".future-dates").style.display = "flex";
...
function choiceDay(obj, date) {
    ...
    console.log("선택된 시작일날짜", startChoiceDay);
    console.log("선택된 마지막날짜", lastChoiceDay);
    console.log("선택되고 있는 카운트", choiceCount);
}

// 선택된 트립 그려주는 함수
function startTripLine(date) {
    let startDate = date;

    for (let date of document.querySelectorAll(".this")) {
        if (+date.innerText === startDate) {
...
function lastTripLine(date) {
    let lastDate = date;

    for (let date of document.querySelectorAll(".this")) {
        if (+date.innerText === lastDate) {
            date.classList.add("startDt");
            break;
        }
    }
